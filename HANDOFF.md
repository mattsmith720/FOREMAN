...
- `npm test --workspace backend` — 62 pass (includes `routes/metrics.test.ts`)
- `npm test --workspace web` — includes `frame-instrumentation`, `cue-metrics`, `session-cost` tests
